...
//           alert("closed");
	...
	requestDataFromServer: function requestDataFromServerFn(lat, lon) {
	 ...
	 // set helper var to avoid requesting places while loading
            ...
            var serverUrl =ServerInformation.POIDATA_SERVER + ServerInformation.POIDATA_CATEGORY + ServerInformation.POIDATA_EXT + "?key=VSv5MxsGbcZLqfQZPePMxkmD64yRBRKs&" + ServerInformation.POIDATA_SERVER_ARG_LAT + "=" + lat + "&" + ServerInformation.POIDATA_SERVER_ARG_RADIUS + "=" + ServerInformation.POI_RADIUS_VALUE + "&" + ServerInformation.POIDATA_SERVER_ARG_LON + "=" + lon + "&limit=25&language=en-GB";;
            // server-url to JSON content provider
            if(World.isNearbySearchEnable){
                 serverUrl = ServerInformation.POIDATA_NEARBY_SEARCH + ServerInformation.POIDATA_CATEGORY + ServerInformation.POIDATA_EXT + "?key=VSv5MxsGbcZLqfQZPePMxkmD64yRBRKs&" + ServerInformation.POIDATA_SERVER_ARG_LAT + "=" + lat + "&" + ServerInformation.POIDATA_SERVER_ARG_RADIUS + "=" + ServerInformation.POI_RADIUS_VALUE + "&" + ServerInformation.POIDATA_SERVER_ARG_LON + "=" + lon + "&limit=35&language=en-GB";
