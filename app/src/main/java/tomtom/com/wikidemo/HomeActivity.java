    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LocationListener locationListener = new LocationListener() {
            public void onLocationChanged(Location location) {
                ...
                if (location != null && HomeActivity.this.architectView != null) {
                    ...
                    if (location.hasAltitude() && location.hasAccuracy()) {
                        ...
                        HomeActivity.this.architectView.setLocation(location.getLatitude(), location.getLongitude(), location.getAltitude(), location.getAccuracy());
                    } else {
                        Log.d("LocationListener","Location has altitude and setting up" + location.getAltitude());
                        HomeActivity.this.architectView.setLocation( location.getLatitude(), location.getLongitude(), location.hasAccuracy() ? location.getAccuracy() : 1000 );
                    }
                }
            }
